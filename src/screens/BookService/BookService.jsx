...
const BookService = ({ selectedShop, userData, closeBookService }) => {
    ...
    return (
        <>
         {console.log("HHEHEHEH" + JSON.stringify(selectedItem))}
            {itemCheckOut ?
                <ItemCheckout closeBookService={closeBookService} selectedShop={selectedShop} userData={userData} itemsList={selectedItem} price={price}/>
                :
